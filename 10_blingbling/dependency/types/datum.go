...
import (
	...
	"github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/mysql"
	"github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/sessionctx/stmtctx"
	"github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/terror"
	"github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/types/json"
	"github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/util/charset"
	"github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/util/hack"
)
		...
		if !dec.IsZero() && prec-frac > flen-decimal {
			...
			if !dec.IsZero() && frac > decimal && dec.Compare(&old) != 0 {
				if sc.InInsertStmt || sc.InUpdateOrDeleteStmt {
					// fix https://github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/issues/3895
					// fix https://github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/issues/5532
