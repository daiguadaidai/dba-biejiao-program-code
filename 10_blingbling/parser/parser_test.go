...
import (
	...
	"github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/util/testleak"
)
...
func (s *testParserSuite) TestSimple(c *C) {
	...
	// Fix: https://github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/issues/971
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	...
	table := []testCase{
		...
		// for https://github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/issues/320
		{`(select 1);`, true},

		// for https://github.com/daiguadaidai/dba-biejiao-program-code/10_blingbling/dependency/issues/1050
