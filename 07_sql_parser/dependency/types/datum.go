...
import (
	...
	"github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/sessionctx/stmtctx"
	"github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/terror"
	"github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/types/json"
	"github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/util/charset"
	"github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/util/hack"
)
		...
		if !dec.IsZero() && prec-frac > flen-decimal {
			...
			if !dec.IsZero() && frac > decimal && dec.Compare(&old) != 0 {
				if sc.InInsertStmt || sc.InUpdateOrDeleteStmt {
					// fix https://github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/issues/3895
					// fix https://github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/issues/5532
