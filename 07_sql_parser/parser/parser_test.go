...
import (
	...
	"github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/util/testleak"
)
...
func (s *testParserSuite) TestSimple(c *C) {
	...
	// Fix: https://github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/issues/971
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	...
	table := []testCase{
		...
		// for https://github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/issues/320
		{`(select 1);`, true},

		// for https://github.com/daiguadaidai/dba-biejiao-program-code/07_sql_parser/dependency/issues/1050
